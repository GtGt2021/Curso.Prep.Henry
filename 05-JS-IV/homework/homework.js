...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  objeto[property] = null; // NO SE HACE CON . PORQUE PROPERTY PUEDE CAMBIAR DE NOMBRE
  return objeto;
}
...
function invocarMetodo(objeto, metodo) {
  ...
  // Tu código:
  objeto[metodo](); // no se usa el punto porque sino seria LITERAL metodo el NOMBRE DEL METODO
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  return (objetoMisterioso["numeroMisterioso"] * 5); //PODEMOS USAR PUNTO SI QUEREMOS PORQUE AQUI YA SABEMOS EL NOMBRE EXACTO DE LA PROPIEDAD
